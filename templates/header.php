...
<head>
    ...
    <title><?php echo htmlspecialchars(get_setting('site_title') ?: 'Marketplace'); ?></title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container">
    <a class="navbar-brand" href="index.php"><?php echo htmlspecialchars(get_setting('site_title') ?: 'Marketplace'); ?></a>
...
<div class="container mt-4">
    ...
    <div class="alert alert-warning text-center fw-bold">
        ...
        <a href="return_admin.php" class="btn btn-sm btn-outline-dark ms-2">Return to Admin Panel</a>
    </div>
    <?php endif; ?>