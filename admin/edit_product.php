...
if(isset($_GET["id"]) && !empty(trim($_GET["id"]))){
    ...
    $_SESSION['product_error'] = "Invalid class specified.";
    ...
    if($stmt_fetch = $mysqli->prepare($sql_fetch)){
        ...
        if($stmt_fetch->execute()){
            ...
            if($result->num_rows == 1){
                ...
                $_SESSION['product_error'] = "Class not found.";
                header("location: manage_products.php");
                exit();
            }
        }
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <?php else: ?>
                            <p class="text-muted">No files are currently associated with this class.</p>
                        <?php endif; ?>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="form-text">Select one or more new files to add to this class.</div>
                    </div>
                    <hr>
                    <div class="mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3 form-check">
                        ...
                        <label class="form-check-label" for="is_featured">Featured Class</label>
                    </div>
                    <div class="mb-3 form-check">
