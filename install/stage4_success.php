...
<div class="alert alert-danger">
    ...
    <p>For the security of your application, you should now <strong>DELETE</strong> the main <code>install.php</code> file and the entire <code>/install</code> directory from your server.</p>
</div>
