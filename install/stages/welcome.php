...
<head>
    ...
    <title>Welcome to the Installer</title>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-<?php echo $php_version_ok ? 'success' : 'danger'; ?>">
                            <?php echo $php_version_ok ? 'OK' : 'Required: >= '.$php_version_required.', You have: '.PHP_VERSION; ?>
                        </span>
                    </li>
                ...
                <div class="mt-4">
                    ...
                    <?php else: ?>
                        <div class="alert alert-danger">Please fix the issues above before proceeding.</div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
