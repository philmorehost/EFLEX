...
require_once 'includes/helpers.php'; // For finalize_successful_order
...
$cart_items = [];
$total_price = 0;
$product_details_for_cart = []; // To pass to finalize function
if(!empty($_SESSION['cart'])){
    ...
    if($stmt = $mysqli->prepare($sql)){
        ...
        while($row = $result->fetch_assoc()){
            ...
            $product_details_for_cart[$product_id] = $row; // Store full details
        }
        $stmt->close();
    }
}
...
<div class="row">
    ...
    <div class="col-md-7 col-lg-8">
        ...
        <form action="checkout.php" method="post" id="checkout-form">
            <!-- For simplicity, we assume user details are in their profile. A real app would have shipping/billing address fields here. -->
