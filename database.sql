...
-- Table structure for table `product_local_files`
CREATE TABLE `product_local_files` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `product_id` int(11) NOT NULL,
...
-- Table structure for table `product_google_drive_files`
CREATE TABLE `product_google_drive_files` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL,
